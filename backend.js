/**
 * Created by KnightA on 01/11/2016.
 */
/* */
(function() {
    var Visitor = require("./VisitorAPI");
    //initialize AppMeasurement
//var s = new AppMeasurement();
    var AnalyticsAccount = ['informaeconcomanalyticsdev','informaeconcomanalyticspreprod','informaeconcomanalyticsprod'];
    var s_account=AnalyticsAccount[analytics.AKEnvInt];
    var s=s_gi(s_account);

//Configure Visitor ID Service

// var visitor = new Visitor("301334FA53DB0A850A490D44@AdobeOrg");

// visitor.trackingServer = visitor.trackingServerSecure = "informa.122.2o7.net"; // "informa.d2.sc.omtrdc.net";
//s.account = s_account;
    s.testReturn = function(){
        var result;
        result = s;
    ...
    s.visitor=Visitor.getInstance("301334FA53DB0A850A490D44@AdobeOrg",{
    ...
    function s_doPlugins(s) {
        ...
        /* Set Page View Event */
        // s.events=s.apl(s.events,s.event9,',',2);
    }
    ...
    s.trackingServer="informa.d2.sc.omtrdc.net";       // from Vanessa
    s.trackingServerSecure="informa.d2.sc.omtrdc.net"; // from Vanessa
